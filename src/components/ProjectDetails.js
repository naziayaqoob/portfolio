...
const ProjectDetails = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-900 text-white">
            <div className="single-image-container order-2">
                <motion.img
            ...
            <motion.div 
                ...
                className="bg-gray-900 flex flex-col max-h-full overflow-auto p-8 sidebar order-1 md:fixed md:inset-y-0 md:right-0 z-50"
            >
                <button
